import os
from crypto_lib import CryptoUtils, RSACrypto, DiffieHellman, ElGamalCrypto, ShamirCrypto, VernamCrypto
...
class CryptoSystem:
    ...
    def main(self):
        ...
        while True:
            ...
            print("8 - Шифр Вернама (одноразовый блокнот)")
            print("9 - Тестирование систем шифрования")
            print("0 - Выход")
